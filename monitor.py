...
subscription_id = "31ce1f7b-445a-42da-ab94-67805bfbd34f"
resource_group = "rg-genaiops-project"
aoai_deployment_name = "gpt-4"
aoai_connection_name = "aoai-connection"
project_name = "ai-project-q4utvsttf6gh2"  # Ex: ai-project-lh7b37cbhixdq
endpoint_name = "rag-1312-endpoint"  # Ex: rag-PCLN-endpoint
deployment_name = "rag-1312-deployment"  # Ex: rag-PCLN-deployment
